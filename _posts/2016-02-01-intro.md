...
|---------------|-----------------------------|------------------------|
| `14:00-14:02` | Welcome | Barbara Chapman (HPE)|
...
| `15:00-15:30` | Break |  |
| `15:30-16:00` | Invited Talk: ll HPC Software Scaling for ML Using CXL 3.0 GFAM | Patrick Estep, Micron <a href="slides/Estep_IPDRM.pdf" target="_blank">[PDF]</a> |
