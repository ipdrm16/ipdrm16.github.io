...
|---------------|-----------------------------|------------------------|
| `08:30-08:35` | Welcome | TBA <!--<a href="sc23_ipdrm_Intro_Outro.pdf" target="_blank">[PDF]</a> -->|
...
| `09:30-10:00` | Break |  |
| `10:00-10:30` | Invited Speaker: ChempComp: A Compilation Framework for Computing with Chemical Reaction Network | Antonino Tumeo (PNNL) <!--<a href="Estep_IPDRM.pdf" target="_blank">[PDF]</a>--> |
