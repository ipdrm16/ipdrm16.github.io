...
|---------------|-----------------------------|------------------------|
| `08:30-08:35` | Welcome | Shirley Moore (University of Texas El Paso) <!--<a href="sc23_ipdrm_Intro_Outro.pdf" target="_blank">[PDF]</a> -->|
...
| `11:30-12:00` | SmartNIC Data Exchange Framework | Savoie, Sicoie, Grant <!-- <a href="Chen_IPDRM.pdf" target="_blank">[PDF]</a>--> |
